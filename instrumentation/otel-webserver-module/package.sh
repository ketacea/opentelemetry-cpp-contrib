...
# Install GRPC
cd /; mkdir -p /dependencies/grpc/lib \
...
cd /; mkdir -p /dependencies/opentelemetry/${OPENTELEMETRY_VERSION}/lib \
...
cp -rf /home/sjc/opentelemetry-cpp-contrib/instrumentation/otel-webserver-module /
